...
For a matrix $A$, the notation $A\succeq0$ and $A\succ0$ when $A$ is often used to denote positive semi-definite (PSD) or positive definite (PD) matrices, respectively. \underline{Using the definition of a PD matrix}, we can prove that the sum of two PD matrices is also PD. A very similar approach can be used to prove the sum of two PSD matrices is also PSD.
